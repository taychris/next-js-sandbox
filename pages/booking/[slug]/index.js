...
const Booking = () => {
  ...
  return (
    <>
        ...
        <Layout>
            <div className="flex calculated-min-h-screen w-full flex-col md:flex-row relative">
                <div className="w-full calculated-h-screen md:w-1/2 text-slate-800 flex items-center justify-center flex-col">
                ...
                <div className="w-full relative calculated-h-screen md:w-1/2">
